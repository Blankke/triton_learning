...
#
# 说明：
#   运行 sharing 五路对比 benchmark：
#     - baseline
#     - stream_overlap
#     - single_fused_half_split
#     - single_fused_interleaved
#     - physical_concat
#   结果默认写入 `output/sharing/benchmarks/sharing_five_way_comparison.csv`。
#   如需覆盖默认参数，可在命令前设置环境变量：
#   M=64 H=4096 N=28672 R=2048 DTYPE=fp16 bash scripts/run_sharing_benchmark.sh
